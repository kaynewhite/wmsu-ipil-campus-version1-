...
def admin_dashboard():
    ...
    <div class="grid grid-3 mb-16" style="margin-bottom:24px">
      <div class="stat-card" style="animation-delay:.0s"><div class="stat-icon" style="background:#c0392b"><svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2M9 7a4 4 0 100 8 4 4 0 000-8z"/></svg></div><div><div class="stat-label">Total Users</div><div class="stat-value">{stats['users']}</div></div></div>
      <div class="stat-card" style="animation-delay:.1s"><div class="stat-icon" style="background:#2980b9"><svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/></svg></div><div><div class="stat-label">Courses</div><div class="stat-value">{stats['courses']}</div></div></div>
      <div class="stat-card" style="animation-delay:.2s"><div class="stat-icon" style="background:#27ae60"><svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg></div><div><div class="stat-label">Total Exams</div><div class="stat-value">{stats['exams']}</div></div></div>
      <div class="stat-card" style="animation-delay:.3s"><div class="stat-icon" style="background:#8e44ad"><svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg></div><div><div class="stat-label">Teachers</div><div class="stat-value">{stats['teachers']}</div></div></div>
      ...
      <div class="stat-card" style="animation-delay:.5s"><div class="stat-icon" style="background:#16a085"><svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"/></svg></div><div><div class="stat-label">Submissions</div><div class="stat-value">{stats['results']}</div></div></div>
    </div>
    <div class="grid grid-2">
      ...
      <div class="card"><div class="card-header"><h3 class="card-title">System Info</h3></div>
        <table style="width:100%">
          <tr><td class="text-muted text-sm">Exams Completed</td><td class="font-bold">{stats['results']}</td></tr>
          <tr><td class="text-muted text-sm">Active Courses</td><td class="font-bold">{stats['courses']}</td></tr>
        </table>
      </div>
    </div>
  </main>
...
def admin_courses():
    ...
    <div class="card"><div class="table-wrap">
      ...
      <tbody>{rows or '<tr><td colspan="3"><div class="empty-state"><div class="empty-icon">📚</div><p>No courses yet</p></div></td></tr>'}</tbody></table>
    </div></div>
...
def admin_users():
    ...
    <div class="card"><div class="table-wrap">
      ...
      <tbody>{rows or '<tr><td colspan="6"><div class="empty-state"><div class="empty-icon">👤</div><p>No users yet</p></div></td></tr>'}</tbody></table>
    </div></div>
  </main></div>
<script>
